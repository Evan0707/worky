    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
          ...
          <FadeIn delay={0}>
            <div className="mb-10 flex justify-center">
              <div className="animate-logo-spin">
                <Logo className="h-14 w-14 opacity-80" color="white" />
              </div>
            </div>
          </FadeIn>
          ...
          {/* Headline */}
          <FadeIn delay={100}>
            <h1 className="font-heading text-[clamp(2.25rem,5vw,4.5rem)] font-bold leading-[1.08] tracking-tight text-white">
              {t("hero.title")}
              <br />
          ...
          <FadeIn delay={300}>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href={`/${locale}/login`}
                className="group inline-flex items-center gap-2 rounded-full bg-white px-7 py-3 text-[15px] font-medium text-black transition-all hover:bg-neutral-200 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]"
              >
                {t("hero.cta")}
              ...
              <a
                href="#features"
                className="inline-flex items-center gap-2 rounded-full border border-white/10 px-7 py-3 text-[15px] font-medium text-neutral-400 transition-all hover:text-white hover:border-white/25 hover:bg-white/[0.03]"
              >
                {t("hero.ctaSecondary")}
              </a>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <div className="h-8 w-[18px] rounded-full border border-white/10 flex items-start justify-center p-1">
      ...
      {/* ───────── FEATURES ───────── */}
      <section id="features" className="relative bg-[#0a0a0a] py-28 sm:py-36">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid gap-px sm:grid-cols-2 lg:grid-cols-3 bg-white/[0.04] rounded-2xl overflow-hidden border border-white/[0.06]">
            {features.map((feature, i) => (
              <FadeIn key={feature.title} delay={i * 60}>
                <div className="group relative bg-[#0a0a0a] p-8 transition-colors duration-300 hover:bg-[#111]">
                  <feature.icon className="mb-5 h-5 w-5 text-neutral-500 transition-colors group-hover:text-white" />
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <FadeIn delay={200}>
                ...
                <div className="relative z-10 flex justify-center lg:justify-start">
                  <Image
                    ...
                    className="w-full max-w-[320px] lg:max-w-[300px] object-contain drop-shadow-2xl translate-y-4"
                    priority
                  />
                </div>
              </FadeIn>
            ...
            <div className="relative z-10">
              <FadeIn>
                <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(255,255,255,0.08)] bg-white/[0.02] px-3 py-1 mb-6">
                  <span className="flex h-2 w-2 rounded-full bg-blue-500"></span>
                  <span className="text-[13px] font-medium uppercase tracking-[0.1em] text-neutral-300">
                    {t("mobileApp.badge")}
                  </span>
                </div>
                <h2 className="font-heading text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-[2.75rem] leading-[1.1]">
                  {t("mobileApp.title")}
                </h2>
                ...
                <div className="mt-10 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[15px] font-medium text-white">{t("mobileApp.features.offline")}</h4>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[15px] font-medium text-white">{t("mobileApp.features.notifications")}</h4>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[15px] font-medium text-white">{t("mobileApp.features.fast")}</h4>
                    </div>
                  </div>
                </div>
              </FadeIn>
      ...
      {/* ───────── HOW IT WORKS ───────── */}
      <section className="relative bg-[#0a0a0a] py-28 sm:py-36">
        <div className="mx-auto max-w-5xl px-6">
          {/* Divider */}
              ...
              <FadeIn key={step.num} delay={i * 120}>
                <div className="relative">
                  ...
                  <div className="mb-6 flex items-center gap-4">
                    <span className="text-[48px] font-bold leading-none text-white/[0.06] tabular-nums">
                      {step.num}
                    </span>
                    {/* Connector (desktop) */}
                    {i < steps.length - 1 && (
      ...
      {/* ───────── PRICING ───────── */}
      <section id="pricing" className="relative bg-[#0a0a0a] py-28 sm:py-36">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 max-w-3xl mx-auto">
            {/* Free plan */}
            <FadeIn delay={0}>
              <div className="rounded-2xl border border-white/[0.06] bg-[#111] p-8 flex flex-col h-full">
                <h3 className="text-lg font-semibold text-white">{t("pricing.free.name")}</h3>
                ...
                <ul className="mt-8 space-y-3.5 flex-1">
                  {freeFeatures.map((feature) => (
                    <li key={feature} className="flex items-start gap-3 text-[14px] text-neutral-400">
                ...
                <Link
                  href={`/${locale}/login`}
                  className="mt-8 flex items-center justify-center rounded-full border border-white/[0.1] bg-transparent px-6 py-2.5 text-[14px] font-medium text-white transition-all hover:bg-white/[0.04] hover:border-white/20"
                >
                  {t("pricing.free.cta")}
                </Link>
              </div>
            ...
            {/* Pro plan */}
            <FadeIn delay={100}>
              <div className="relative rounded-2xl border border-white/[0.12] bg-[#111] p-8 flex flex-col h-full shadow-[0_0_80px_-20px_rgba(255,255,255,0.05)]">
                <div className="absolute -top-3 right-6 rounded-full bg-white px-3 py-0.5 text-[11px] font-semibold text-black">
                  {t("pricing.pro.popular")}
                </div>
                <h3 className="text-lg font-semibold text-white">{t("pricing.pro.name")}</h3>
                <p className="mt-1 text-[14px] text-neutral-500">
                ...
                <Link
                  href={`/${locale}/login`}
                  className="mt-8 flex items-center justify-center rounded-full bg-white px-6 py-2.5 text-[14px] font-medium text-black transition-all hover:bg-neutral-200"
                >
                  {t("pricing.pro.cta")}
                </Link>
              </div>
      ...
      <section className="relative bg-[#0a0a0a] py-32 sm:py-40 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-6 text-center">
          <FadeIn>
            <Logo className="h-10 w-10 mx-auto mb-8 opacity-40" color="white" />
            ...
            <Link
              href={`/${locale}/login`}
              className="group mt-10 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-[15px] font-medium text-black transition-all hover:bg-neutral-200 hover:shadow-[0_0_40px_rgba(255,255,255,0.1)]"
            >
              {t("cta.button")}
              <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
            </Link>
